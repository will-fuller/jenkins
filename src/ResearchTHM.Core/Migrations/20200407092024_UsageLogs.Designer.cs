...
namespace ResearchTHM.Core.Migrations
{
    ...
    [Migration("20200407092024_UsageLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResearchTHM.Core.Models.MktSavedSearch", b =>
                {
                    ...
                    b.Property<bool?>("IsexcludedCtb")
                        .HasColumnName("isexcludedCtb")
                        .HasColumnType("bit");

                    b.Property<string>("KeywordCon")
                        .HasColumnName("keyword_con")
                        .HasColumnType("varchar(20)")
                        .HasMaxLength(20)
                        .IsUnicode(false);

                    b.Property<string>("MatchStrHdln")
                        .HasColumnName("matchStrHdln")
                        .HasColumnType("nvarchar(1000)")
                        .HasMaxLength(1000);

                    b.Property<string>("MatchStrText")
                        .HasColumnName("matchStrText")
                        .HasColumnType("nvarchar(1000)")
                        .HasMaxLength(1000);
            ...
            modelBuilder.Entity("ResearchTHM.Core.Models.MktUsageLog", b =>
                {
                    ...
                    b.Property<string>("BrowerName")
                        .HasColumnName("brower_name")
                        .HasColumnType("varchar(250)")
                        .HasMaxLength(250)
                        .IsUnicode(false);

                    b.Property<string>("BrowerVersion")
                        .HasColumnName("brower_version")
                        .HasColumnType("varchar(250)")
                        .HasMaxLength(250)
                        .IsUnicode(false);
            ...
            modelBuilder.Entity("ResearchTHM.Core.Models.MktUserPreference", b =>
                {
                    b.Property<Guid?>("UserId")
                        .HasColumnName("user_id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ResearchTHM.Core.Models.MktUserPreference", b =>
                {
                    b.HasOne("ResearchTHM.Core.Models.MktUser", "User")
                        .WithMany("MktUserPreference")
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_pref_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
