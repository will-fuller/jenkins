...
namespace ResearchTHM.Core.Migrations
{
    ...
    [Migration("20200423140359_savedTextSearchColumns")]
    partial class savedTextSearchColumns
    {
            ...
            modelBuilder.Entity("ResearchTHM.Core.Models.MktSavedSearch", b =>
                {
                    ...
                    b.Property<string>("keyword3Search")
                        .HasColumnName("keyword3Search")
                        .HasColumnType("varchar(500)")
                        .HasMaxLength(500)
                        .IsUnicode(false);

                    b.Property<string>("keyword3Type")
                        .HasColumnName("keyword3Type")
                        .HasColumnType("varchar(20)")
                        .HasMaxLength(20)
                        .IsUnicode(false);
